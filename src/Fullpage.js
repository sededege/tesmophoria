...
const Fullpage = () => {
  ...
  React.useEffect(() => {}, [number, pantalla, state]);
  ...
  return (
    <div ref={ctoref} className="text-tesmo bg-tesmo">
          ...
          <div className="flex flex-col text-center mt-20 md:mt-0 justify-between items-center font text-white ">
            <div>
              ...
              <p className="  text-[1.2rem]">
                ...
                enhancing productivity, improving efficiency, and enabling new
                possibilities for onboarding users.{" "}
              </p>
            </div>
            <div>
              <h1 className=" text-white menu md:text-[3rem] text-[2rem]  ">
            ...
            <div>
              ...
              <p className=" text-[1.2rem]">
                Fostering a respectful community with inclusivity for women in
                web3 Preventing rugs and assisting derugs <br></br>
      ...
      <div className="w-full h-full bg-tesmo p-10 md:p-20 text-[3rem] menu">
        <h1 ref={catref} className="text-white text-left">
          Our History
        </h1>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-4 md:[&>*:nth-child(odd)]:mt-20">
          <div className="w-full">
            <Tweet tweetId="1624606539620433920" options={{ theme: "dark" }} />
          </div>
          {/*  <div className="w-full">
                <Tweet
          ...
          <div className="w-full">
            <Tweet tweetId="1624804770539085825" options={{ theme: "dark" }} />
          </div>
          <div className="w-full">
            <Tweet tweetId="1624841242055004161" options={{ theme: "dark" }} />
          </div>
          <div className="w-full">
            <Tweet tweetId="1624109741151485954" options={{ theme: "dark" }} />
          </div>
          <div className="w-full">
            <Tweet tweetId="1624603322194829313" options={{ theme: "dark" }} />
          </div>
          <div className="w-full">
            <Tweet tweetId="1624968821181231105" options={{ theme: "dark" }} />
          </div>
          <div className="w-full">
            <Tweet tweetId="1624418109409972226" options={{ theme: "dark" }} />
          </div>
          <div className="w-full">
            <Tweet tweetId="1624823798003294212" options={{ theme: "dark" }} />
          </div>
          <div className="w-full">
            <Tweet tweetId="1624580663855788032" options={{ theme: "dark" }} />
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-tesmo  p-4 md:p-20 md:text-center  menu">
        <h1
          ref={capref}
          className="text-[3rem] text-white menu text-center md:text-left"
        >
          Team
        </h1>
